...
class UR7e_CubeGrasp(Node):
    ...
    def cube_callback(self, cube_pose):
        ...
        # 4) Move back to Pre-Grasp Position
        joint_state = self.ik_planner.compute_ik(self.joint_state, self.cube_pose.point.x + 0.25, self.cube_pose.point.y - 0.035, self.cube_pose.point.z + 0.25)
        self.job_queue.append(joint_state)


        # ADD ON: Rotate single joint to make pen write
        self.job_queue.append(joint_state)
